...
@Client.on_message(filters.command(["tat", f"tat@{Config.BOT_USERNAME}"]) & admin_filter & chat_filter)
...
@Client.on_message(filters.command(["bat", f"bat@{Config.BOT_USERNAME}"]) & admin_filter & chat_filter)
